...
const FloatingDockDesktop = ({
  ...
  return (
    <motion.div
      ...
      className={cn(
        "fixed bottom-4 left-1/2 transform -translate-x-1/2 z-50 hidden md:flex h-16 gap-4 items-end rounded-2xl bg-neutral-900 px-4 pb-3",
        className
      )}
    >
      {items.map((item) => (
...
function IconContainer({
  ...
  return (
    <Link
      ...
      rel={href.endsWith(".pdf") || isExternalLink ? "noopener noreferrer" : undefined}
    >
      <motion.div
        ref={ref}
        style={{ width, height }}
